...
const quote = (io: Server) => {
  ...
  router.get(
    ...
    asyncHandler(async (req, res) => {
      ...
      const ingressFee = await getIngressFee(srcAssetChain);
      ...
      try {
        ...
        const egressFee = bigintMin(
          await getEgressFee(destAssetChain),
        ...
        const minimumEgressAmount = await getMinimumEgressAmount(srcAssetChain);
